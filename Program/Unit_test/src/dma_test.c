...
dma_ch_csr_config DMA_Config_UART_RX;
dma_ch_csr_config DMA_Config_UART_TX;
dma_ch_csr_config DMA_Config_SPI_RX;
dma_ch_csr_config DMA_Config_SPI_TX;
...
void SystemInit(void) {
    ...
    //  Send from testbench (UART).

    DMA_Config_UART_RX.HBURST = 0;
    DMA_Config_UART_RX.KEEP_REGS = 1;
    DMA_Config_UART_RX.HSIZE = 0;
    DMA_Config_UART_RX.REST_EN = 0;
    DMA_Config_UART_RX.CHANNEL_PRIORITY = 0;
    DMA_Config_UART_RX.ARS = 0;
    DMA_Config_UART_RX.MODE = 1;
    DMA_Config_UART_RX.INC_SRC = 0;
    DMA_Config_UART_RX.INC_DST = 1;
    DMA_Config_UART_RX.CH_EN = 1;
    DMA_Config_UART_RX.INE_DONE = 0;
    DMA_Config_UART_RX.INE_ERROR = 0;

    DMA_enable(CMSDK_DMA, 0);
    DMA_CH_setReq(CMSDK_DMA, 5, 5, 0);  // check the arguments
    DMA_CH_setSZ(CMSDK_DMA, 4, 7, 0);
    DMA_CH_setA0(CMSDK_DMA, 0x40004000UL, 0);
    DMA_CH_setA1(CMSDK_DMA, (uint32_t)string, 0);
    DMA_CH_setCSR(CMSDK_DMA, &DMA_Config_UART_RX, 0);

    //  Send CTS0.

    DMA_Config_UART_TX.HBURST = 0;
    DMA_Config_UART_TX.KEEP_REGS = 1;
    ...
    DMA_Config_UART_TX.INE_DONE = 0;
    DMA_Config_UART_TX.INE_ERROR = 0;

    DMA_CH_setReq(CMSDK_DMA, 2, 2, 1); // check the arguments
    DMA_CH_setSZ(CMSDK_DMA, 0, 7, 1);
    DMA_CH_setA0(CMSDK_DMA, (uint32_t)string, 1);
    DMA_CH_setA1(CMSDK_DMA, 0x40000000UL, 1);
    DMA_CH_setCSR(CMSDK_DMA, &DMA_Config_UART_TX, 1);
...
int main(void) {
    ...
    DMA_Config_SPI_TX.HBURST = 0;
    DMA_Config_SPI_TX.KEEP_REGS = 1;
    DMA_Config_SPI_TX.HSIZE = 0;
    DMA_Config_SPI_TX.REST_EN = 0;
    DMA_Config_SPI_TX.CHANNEL_PRIORITY = 0;
    DMA_Config_SPI_TX.ARS = 0;
    DMA_Config_SPI_TX.MODE = 1;
    DMA_Config_SPI_TX.INC_SRC = 1;
    DMA_Config_SPI_TX.INC_DST = 0;
    DMA_Config_SPI_TX.CH_EN = 1;
    DMA_Config_SPI_TX.INE_DONE = 0;
    DMA_Config_SPI_TX.INE_ERROR = 0;

    DMA_CH_setReq(CMSDK_DMA, 0, 0, 0);  // check the arguments
    DMA_CH_setSZ(CMSDK_DMA, 8, 16, 0);
    DMA_CH_setA0(CMSDK_DMA, (uint32_t)string, 0);
    DMA_CH_setA1(CMSDK_DMA, 0x40003004UL, 0);
    DMA_CH_setCSR(CMSDK_DMA, &DMA_Config_SPI_TX, 0);
    ...
    //  Send from testbench (SPI).

    DMA_Config_SPI_RX.HBURST = 0;
    DMA_Config_SPI_RX.KEEP_REGS = 1;
    ...
    DMA_Config_SPI_RX.INE_DONE = 0;
    DMA_Config_SPI_RX.INE_ERROR = 0;

    DMA_CH_setReq(CMSDK_DMA, 1, 1, 1);  // check the arguments
    DMA_CH_setSZ(CMSDK_DMA, 7, 14, 1);
    DMA_CH_setA0(CMSDK_DMA, 0x40003004UL, 1);
    DMA_CH_setA1(CMSDK_DMA, (uint32_t)string, 1);
    DMA_CH_setCSR(CMSDK_DMA, &DMA_Config_SPI_RX, 1);
    ...
    DMA_CH_setReq(CMSDK_DMA, 8, 0, 0);  // check the arguments
    DMA_CH_setSZ(CMSDK_DMA, 0, 127, 0);
    DMA_CH_setA0(CMSDK_DMA, (uint32_t)wordArray, 0);
    DMA_CH_setA1(CMSDK_DMA, 0X40021010, 0);
    DMA_CH_setCSR(CMSDK_DMA, &DMA_Config_WIFI_TX, 0);
    ...
    DMA_CH_setReq(CMSDK_DMA, 6, 1, 1);  // check the arguments
    DMA_CH_setSZ(CMSDK_DMA, 0, 138, 1);
    DMA_CH_setA0(CMSDK_DMA, (uint32_t)data, 1);
    DMA_CH_setA1(CMSDK_DMA, 0X40020010, 1);
    DMA_CH_setCSR(CMSDK_DMA, &DMA_Config_BLE_TX, 1);
...
void __attribute__((used)) GPIO_INT_02_Handler(void)
{
    ...
    DMA_CH_setA1(CMSDK_DMA, (uint32_t)data_out_ble, 1);
