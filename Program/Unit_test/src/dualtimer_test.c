...
dualtimer_configuration dualtimer_conf;

void SystemInit(void) {
      dualtimer_conf.irq_en1=1;
      dualtimer_conf.oneshot1=1;
      dualtimer_conf.freerunning1=0;
      dualtimer_conf.prescale1=2;
      dualtimer_conf.enable1=1;
      dualtimer_conf.bits1=1;

      dualtimer_conf.irq_en2=0;
      dualtimer_conf.oneshot2=0;
      dualtimer_conf.freerunning2=1;
      dualtimer_conf.prescale2=1;
      dualtimer_conf.enable2=1;
      dualtimer_conf.bits2=0;

      dualtimer_config(DUALTIMER,&dualtimer_conf);

      
}

int main(void) {
      dualtimer_set_timer1_load(DUALTIMER,1000);
      dualtimer_set_timer2_load(DUALTIMER,70000);
}
...
void DUAL_TIMER1_INT_Handler(void)
{

}

void DUAL_TIMERC_INT_Handler(void)
{
      dualtimer_irq_handler_combined();
}
...
const void* VectorTable[] __attribute__ ((section(".vtor"))) = {
    ...
    DUAL_TIMER1_INT_Handler,
    DUAL_TIMER2_INT_Handler,
    DUAL_TIMERC_INT_Handler,
