...
int main(void) {
    ...
    serial_uart_transmit_string_poll( UART0,"Hello"); /////////////////// transmit polling
     ...
     serial_uart_transmit_string_poll( UART0,"Hello");
    ...
    //serial_uart_receive_string_poll( UART1 , str1); ///////////////////// recieve polling

    //serial_uart_receive_string_int( UART1 , str2);  ///////////////// recieve interrupt

    // calling for printf function
    const char *name = "Bassel";
    int age = 72;
