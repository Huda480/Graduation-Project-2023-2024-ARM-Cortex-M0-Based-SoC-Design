...
dma_ch_csr_config DMA_Config_MEM;
...
void SystemInit(void) {
    ...
    serial_uart_transmit_string_poll(UART0, "HelloHelloHello\0");

    serial_uart_transmit_string_poll(UART1, "Hello2Hello2Hel");
    ...
    DMA_CH_setReq(CMSDK_DMA, 3, 0, 0);
    DMA_CH_setSZ(CMSDK_DMA, 0, 15, 0);
    DMA_CH_setA0(CMSDK_DMA, 0x40000000UL, 0);
    DMA_CH_setA1(CMSDK_DMA, (uint32_t)bytes, 0);
    ...
    ////////////////////////////////////////////////////////
    //  WRAP TEST 1 : WORD/WRAP4
    ////////////////////////////////////////////////////////

    DMA_Config_MEM.HBURST = 2;
    DMA_Config_MEM.P2P = 0;
    DMA_Config_MEM.KEEP_REGS = 1;
    DMA_Config_MEM.HSIZE = 2;
    DMA_Config_MEM.REST_EN = 0;
    DMA_Config_MEM.CHANNEL_PRIORITY = 0;
    DMA_Config_MEM.ARS = 0;
    DMA_Config_MEM.MODE = 0;
    DMA_Config_MEM.INC_SRC = 1;
    DMA_Config_MEM.INC_DST = 1;
    DMA_Config_MEM.CH_EN = 1;
    DMA_Config_MEM.INE_DONE = 0;
    DMA_Config_MEM.INE_ERROR = 0;

    DMA_CH_setReq(CMSDK_DMA, 0,0, 0);
    DMA_CH_setSZ(CMSDK_DMA, 4, 16, 0);
    DMA_CH_setA0(CMSDK_DMA, (uint32_t)words, 0);
    DMA_CH_setA1(CMSDK_DMA, (uint32_t)words_out, 0);
    DMA_CH_setCSR(CMSDK_DMA, &DMA_Config_MEM, 0);

    while ((DMA_CH_getCSR(CMSDK_DMA, 0) & 1) != 0);

    ////////////////////////////////////////////////////////
    //  WRAP TEST 2 : WORD/WRAP8
    ////////////////////////////////////////////////////////

    DMA_Config_MEM.HBURST = 4;
    DMA_Config_MEM.P2P = 0;
    DMA_Config_MEM.KEEP_REGS = 1;
    DMA_Config_MEM.HSIZE = 2;
    DMA_Config_MEM.REST_EN = 0;
    ...
    ////////////////////////////////////////////////////////
    //  WRAP TEST 3 : WORD/WRAP16
    ////////////////////////////////////////////////////////

    DMA_Config_MEM.HBURST = 6;
    DMA_Config_MEM.P2P = 0;
    DMA_Config_MEM.KEEP_REGS = 1;
    DMA_Config_MEM.HSIZE = 2;
    DMA_Config_MEM.REST_EN = 0;
    ...
    DMA_CH_setReq(CMSDK_DMA, 0,0, 0);
    DMA_CH_setSZ(CMSDK_DMA, 16, 32, 0);
    DMA_CH_setA0(CMSDK_DMA, (uint32_t)words, 0);
    DMA_CH_setA1(CMSDK_DMA, (uint32_t)words_out, 0);
    DMA_CH_setCSR(CMSDK_DMA, &DMA_Config_MEM, 0);
    ...
    ////////////////////////////////////////////////////////
    //  WRAP TEST 4 : HALFWORD/WRAP4
    ////////////////////////////////////////////////////////

    DMA_Config_MEM.HBURST = 2;
    DMA_Config_MEM.P2P = 0;
    DMA_Config_MEM.KEEP_REGS = 1;
    DMA_Config_MEM.HSIZE = 1;
    DMA_Config_MEM.REST_EN = 0;
    DMA_Config_MEM.CHANNEL_PRIORITY = 0;
    DMA_Config_MEM.ARS = 0;
    DMA_Config_MEM.MODE = 0;
    ...
    ////////////////////////////////////////////////////////
    //  WRAP TEST 7 : BYTES/WRAP4
    ////////////////////////////////////////////////////////

    DMA_Config_MEM.HBURST = 2;
    DMA_Config_MEM.P2P = 0;
    DMA_Config_MEM.KEEP_REGS = 1;
    DMA_Config_MEM.HSIZE = 0;
    DMA_Config_MEM.REST_EN = 0;
    DMA_Config_MEM.CHANNEL_PRIORITY = 0;
    DMA_Config_MEM.ARS = 0;
    DMA_Config_MEM.MODE = 0;
    ...
    descriptor L2 = {
        .CTRL = (1<<20) | (1<<19) | (1<<18) | 12,
        .A0   = (uint32_t)words,
        .A1   = (uint32_t)words_out,
        .NEXT = 0
    };
    ...
    DMA_CH_setCSR(CMSDK_DMA, &DMA_Config_UART, 0);
    DMA_CH_setDESC(CMSDK_DMA, (uint32_t)&L3, 0);
    DMA_CH_enable(CMSDK_DMA, 1, 0);
    

    /*DMA_Config_MEM.HBURST = 0;
    DMA_Config_MEM.P2P = 1;
    DMA_Config_MEM.KEEP_REGS = 1;
    DMA_Config_MEM.HSIZE = 2;
    DMA_Config_MEM.REST_EN = 0;
    DMA_Config_MEM.CHANNEL_PRIORITY = 0;
    ...
    DMA_Config_MEM.INC_SRC = 1;
    DMA_Config_MEM.INC_DST = 1;
    DMA_Config_MEM.USE_ED = 1;
    DMA_Config_MEM.CH_EN = 0;
    DMA_Config_MEM.INE_DONE = 0;
    DMA_Config_MEM.INE_ERROR = 0;

    DMA_CH_setSZ(CMSDK_DMA, 4, 4, 0);
    DMA_CH_setCSR(CMSDK_DMA, &DMA_Config_MEM, 0);
    DMA_CH_setDESC(CMSDK_DMA, (uint32_t)&L1, 0);
    DMA_CH_enable(CMSDK_DMA, 1, 0);*/
