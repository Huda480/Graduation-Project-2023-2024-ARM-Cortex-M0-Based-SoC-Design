...
// -----------------------------------------------------------------------------
    ...
    wire         i_hready_mux_m8;    // Internal HREADYMUXM for MI6
...
// -----------------------------------------------------------------------------
  ...
  // Input stage for SI0
  AHB_InputStage_COMP u_AHB_InputStage_COMP_0 (
  ...
  AHB_DecoderStage_COMPS0 u_ahb_decoderstage_comps0 (
  ...
  AHB_OutputStage_COMP u_ahb_outputstage_comp_0 (
  ...
  AHB_OutputStage_COMP u_ahb_outputstage_comp_1 (
  ...
  AHB_OutputStage_COMP u_ahb_outputstage_comp_2 (
  ...
  AHB_OutputStage_COMP u_ahb_outputstage_comp_3 (
  ...
  AHB_OutputStage_COMP u_ahb_outputstage_comp_4 (
  ...
  AHB_OutputStage_COMP u_ahb_outputstage_comp_5 (
  ...
  AHB_OutputStage_COMP u_ahb_outputstage_comp_6 (
