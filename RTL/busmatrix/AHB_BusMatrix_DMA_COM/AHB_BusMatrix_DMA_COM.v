...
// -----------------------------------------------------------------------------
    ...
    wire         i_hready_mux_m8;    // Internal HREADYMUXM for MI7
...
// -----------------------------------------------------------------------------
  ...
  // Input stage for SI0
  AHB_InputStage_DMA_COM u_AHB_InputStage_DMA_COM_0 (
  ...
  // Input stage for SI1
  AHB_InputStage_DMA_COM u_AHB_InputStage_DMA_COM_1 (
  ...
  AHB_DecoderStage_DMA_COMS0 u_ahb_decoderstage_dma_coms0 (
  ...
  AHB_DecoderStage_DMA_COMS1 u_ahb_decoderstage_dma_coms1 (
  ...
  AHB_OutputStage_DMA_COM u_ahb_outputstage_dma_com_0 (
  ...
  AHB_OutputStage_DMA_COM u_ahb_outputstage_dma_com_1 (
  ...
  AHB_OutputStage_DMA_COM u_ahb_outputstage_dma_com_2 (
  ...
  AHB_OutputStage_DMA_COM u_ahb_outputstage_dma_com_3 (
  ...
  AHB_OutputStage_DMA_COM u_ahb_outputstage_dma_com_4 (
  ...
  AHB_OutputStage_DMA_COM u_ahb_outputstage_dma_com_5 (
  ...
  AHB_OutputStage_DMA_COM u_ahb_outputstage_dma_com_6 (
  ...
  AHB_OutputStage_DMA_COM u_ahb_outputstage_dma_com_7 (
