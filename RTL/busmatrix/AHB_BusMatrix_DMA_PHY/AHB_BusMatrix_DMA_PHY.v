...
// -----------------------------------------------------------------------------
  ...
  // Input stage for SI0
  AHB_InputStage_DMA_PHY u_AHB_InputStage_DMA_PHY_0 (
  ...
  // Input stage for SI1
  AHB_InputStage_DMA_PHY u_AHB_InputStage_DMA_PHY_1 (
  ...
  AHB_DecoderStage_DMA_PHYS0 u_ahb_decoderstage_dma_phys0 (
  ...
  AHB_DecoderStage_DMA_PHYS1 u_ahb_decoderstage_dma_phys1 (
  ...
  AHB_OutputStage_DMA_PHY u_ahb_outputstage_dma_phy_0 (
  ...
  AHB_OutputStage_DMA_PHY u_ahb_outputstage_dma_phy_1 (
  ...
  AHB_OutputStage_DMA_PHY u_ahb_outputstage_dma_phy_2 (
  ...
  AHB_OutputStage_DMA_PHY u_ahb_outputstage_dma_phy_3 (
  ...
  AHB_OutputStage_DMA_PHY u_ahb_outputstage_dma_phy_4 (
  ...
  AHB_OutputStage_DMA_PHY u_ahb_outputstage_dma_phy_5 (
  ...
  AHB_OutputStage_DMA_PHY u_ahb_outputstage_dma_phy_6 (
  ...
  AHB_OutputStage_DMA_PHY u_ahb_outputstage_dma_phy_7 (
