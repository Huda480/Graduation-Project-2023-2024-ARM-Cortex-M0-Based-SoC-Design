...
// -----------------------------------------------------------------------------
  ...
  // Input stage for SI0
  AHB_InputStage_DMA_BLE u_AHB_InputStage_DMA_BLE_0 (
  ...
  // Input stage for SI1
  AHB_InputStage_DMA_BLE u_AHB_InputStage_DMA_BLE_1 (
  ...
  AHB_DecoderStage_DMA_BLES0 u_ahb_decoderstage_dma_bles0 (
  ...
  AHB_DecoderStage_DMA_BLES1 u_ahb_decoderstage_dma_bles1 (
  ...
  AHB_OutputStage_DMA_BLE u_ahb_outputstage_dma_ble_0 (
  ...
  AHB_OutputStage_DMA_BLE u_ahb_outputstage_dma_ble_1 (
  ...
  AHB_OutputStage_DMA_BLE u_ahb_outputstage_dma_ble_2 (
  ...
  AHB_OutputStage_DMA_BLE u_ahb_outputstage_dma_ble_3 (
  ...
  AHB_OutputStage_DMA_BLE u_ahb_outputstage_dma_ble_4 (
  ...
  AHB_OutputStage_DMA_BLE u_ahb_outputstage_dma_ble_5 (
  ...
  AHB_OutputStage_DMA_BLE u_ahb_outputstage_dma_ble_6 (
